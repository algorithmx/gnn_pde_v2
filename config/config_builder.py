...
from ..models.unified_model import Model, LossFunction
from .base_config import ModelConfig, TrainingConfig, FNOConfig, GNNConfig
...
class ConfigBuilder:
    ...
    def build_model(self, device: Optional[str] = None) -> BaseModel:
        """
        ...
        if isinstance(config, FNOConfig):
            ...
            model_class = BaseModel.get_model(model_type)
    ...
    def _build_fno(self, config: FNOConfig) -> BaseModel:
        """Build FNO model."""
    ...
    def _build_gnn(self, config: GNNConfig) -> BaseModel:
        """Build GNN model."""
